...
پیمانگران، جویندگان دانشی هستند که در تاروپود جهانگان پنهان مانده است. از طریق پیمان‌هایی که با موجودات مرموز دارای قدرت ماوراءالطبیعه می‌بندند، پیمانگران به افسون‌های ظریف و باشکوهی دست می‌یابند. پیمانگران با تکیه بر دانش باستانی موجوداتی چون اشراف پری، دیوها، اهریمن‌ها، جادوگران و موجودات بیگانه از قلمرو دوردست، رموز جادویی را کنار هم می‌چینند تا قدرت خود را افزایش دهند.

## سوگند و تعهد
یک پیمانگر با پیمانی که با یک موجود فراطبیعی می‌بندد، تعریف می‌شود. گاهی رابطه بین پیمانگر و موکلش شبیه رابطه یک راهب و ایزد است، هرچند موجوداتی که به عنوان موکل برای پیمانگران عمل می‌کنند، ایزد نیستند. یک پیمانگر ممکن است فرقه‌ای را رهبری کند که به یک شاهزاده دیو، یک اهریمن بزرگ یا یک موجود کاملاً بیگانه سوگند خورده باشد؛ موجوداتی که معمولاً مورد پرستش راهبان نیستند. اما اغلب، این رابطه شبیه رابطه استاد و شاگرد است. پیمانگر یاد می‌گیرد و در قدرت رشد می‌کند، به بهایی که گاهی باید خدماتی را به نمایندگی از موکلش انجام دهد.

جادویی که به یک پیمانگر اعطا می‌شود، از تغییرات کوچک اما ماندگار در وجود پیمانگر (مانند توانایی دیدن در تاریکی یا خواندن هر زبانی) تا دسترسی به طلسم‌های قدرتمند را شامل می‌شود. برخلاف جادوگرهای کتاب‌خوان، پیمانگران جادوی خود را با کمی مهارت در نبرد تن‌به‌تن تکمیل می‌کنند. آنها در زره سبک راحت هستند و می‌دانند که چگونه از سلاح‌های ساده استفاده کنند.

## کاوش در اسرار
پیمانگران توسط نیاز سیری‌ناپذیری به دانش و قدرت هدایت می‌شوند که آنها را به سوی پیمان‌هایشان سوق می‌دهد و زندگی‌شان را شکل می‌دهد. این تشنگی پیمانگران را به سوی پیمان‌هایشان سوق می‌دهد و مسیر حرفه‌ای آنها را نیز شکل می‌دهد.

داستان‌هایی از پیمانگران که خود را به دیوها می‌بندند، به خوبی شناخته شده است. اما بسیاری از پیمانگران، موکلانی غیردیو دارند. گاهی یک مسافر در طبیعت وحشی به یک برج عجیب‌الجمال برمی‌خورد، با ارباب یا بانوی پری آن دیدار می‌کند و بدون اینکه کاملاً متوجه باشد، وارد پیمانی می‌شود. و گاهی، در حالی که مشغول ورق زدن کتاب‌های دانش ممنوعه است، ذهن یک دانش‌آموز درخشان اما دیوانه به واقعیت‌هایی فراتر از جهان مادی و موجودات بیگانه‌ای که در خلأ بیرونی زندگی می‌کنند، گشوده می‌شود.

هنگامی که پیمانی بسته شد، تشنگی پیمانگر برای دانش و قدرت نمی‌تواند با مطالعه و پژوهش خاموش شود. کسی با چنین موکل قدرتمندی پیمان نمی‌بندد مگر اینکه قصد استفاده از قدرتی را که به دست می‌آورد، داشته باشد. در عوض، اکثریت قریب به اتفاق پیمانگران روزهای خود را در تعقیب فعال اهدافشان می‌گذرانند که معمولاً به نوعی ماجراجویی منجر می‌شود. علاوه بر این، خواسته‌های موکلان آنها را به سوی ماجراجویی سوق می‌دهد.

## خلق یک پیمانگر
هنگامی که شخصیت پیمانگر خود را خلق می‌کنید، مدتی را صرف فکر کردن درباره موکل خود و تعهداتی که پیمانتان بر شما تحمیل می‌کند، بکنید. چه چیزی شما را به سوی این پیمان سوق داد و چگونه با موکل خود ارتباط برقرار کردید؟ آیا فریب خوردید تا یک دیو را احضار کنید یا اینکه به دنبال مراسم خاصی بودید که به شما اجازه برقراری ارتباط با یک ایزد بیگانه کهن را می‌داد؟ آیا به دنبال موکل خود گشتید یا اینکه او شما را پیدا کرد و انتخاب کرد؟ آیا زیر بار تعهدات پیمان خود خم می‌شوید یا با شادی به خدمت می‌پردازید تا پاداش‌هایی را که به شما وعده داده شده، به دست آورید؟
...
موکل شما چگونه با شما ارتباط برقرار می‌کند؟ اگر یک همراه جادویی دارید، ممکن است گاهی با صدای موکل شما صحبت کند. برخی پیمانگران پیام‌هایی از موکل خود را بر درختان حکاکی‌شده، در میان برگ‌های چای یا در میان ابرها می‌یابند؛ پیام‌هایی که فقط پیمانگر می‌تواند ببیند. برخی دیگر با موکل خود در رویا یا بینایی‌های بیداری صحبت می‌کنند یا فقط با واسطه‌ها ارتباط برقرار می‌کنند.

### ساخت سریع
شما می‌توانید به سرعت یک پیمانگر خلق کنید با پیروی از این پیشنهادها. اول، جذبه باید بالاترین امتیاز توانایی شما باشد، سپس بنیه. دوم، پیشینه شارلاتان را انتخاب کنید. سوم، وردهای شلیک سحار و لمس سرد را همراه با طلسم‌های سطح اول پرتو بیماری و جادوی جادوگران را انتخاب کنید.

## ویژگی‌های کلاس
به عنوان یک پیمانگر، شما به ویژگی‌های کلاس زیر دست پیدا می‌کنید:

#### امتیاز جان
**تاس جان**: ۱تاس۸ جان برای هر سطح پیمانگر  
**امتیاز جان در سطح اول**: ۸ + عدد اصلاحی بنیه شما  
**امتیاز جان در سطوح بالاتر**: ۱تاس۸ (یا ۵) + عدد اصلاحی بنیه شما برای هر سطح پیمانگر بعد از اول
...
- زره چرمی، هر سلاح ساده‌ای و دو خنجر
...
### جادوی پیمان
تحقیقات جادویی شما و جادویی که موکل شما به شما اعطا کرده، به شما توانایی استفاده از طلسم‌ها را داده است. برای قوانین کلی طلسم‌خوانی به فصل ۱۰ و برای فهرست طلسم‌های پیمانگر به فصل ۱۱ مراجعه کنید.

#### ورد
شما دو ورد از فهرست طلسم‌های پیمانگر را می‌دانید. در سطوح بالاتر، وردهای بیشتری از فهرست طلسم‌های پیمانگر یاد می‌گیرید، همان‌طور که در ستون وردهای دانسته در جدول پیمانگر نشان داده شده است.

#### سهمیه طلسم
جدول پیمانگر نشان می‌دهد که چند سهمیه طلسم دارید. این جدول همچنین سطح این سهمیه‌ها را نشان می‌دهد؛ تمام سهمیه‌های طلسم شما در یک سطح هستند. برای خواندن یکی از طلسم‌های سطح اول یا بالاتر پیمانگر خود، باید یک سهمیه طلسم را مصرف کنید. تمام سهمیه‌های طلسم مصرف‌شده را زمانی که یک استراحت کوتاه یا طولانی انجام می‌دهید، بازیابی می‌کنید.
...
در سطح اول، دو طلسم سطح اول از فهرست طلسم‌های پیمانگر را می‌دانید.

ستون طلسم‌های دانسته در جدول پیمانگر نشان می‌دهد که چه زمانی طلسم‌های بیشتری از فهرست طلسم‌های پیمانگر را یاد می‌گیرید. طلسمی که انتخاب می‌کنید باید در سطحی باشد که در ستون سطح سهمیه جدول برای سطح شما نشان داده شده است. وقتی به سطح ششم می‌رسید، به عنوان مثال، یک طلسم جدید پیمانگر یاد می‌گیرید که می‌تواند در سطح اول، دوم یا سوم باشد.

علاوه بر این، وقتی یک سطح در این کلاس کسب می‌کنید، می‌توانید یکی از طلسم‌های پیمانگری را که می‌دانید انتخاب کنید و آن را با یک طلسم دیگر از فهرست طلسم‌های پیمانگر جایگزین کنید که باید در سطحی باشد که سهمیه آن را دارید.

#### توانایی طلسم‌خوانی
جذبه توانایی طلسم‌خوانی شما برای طلسم‌های پیمانگر شماست، بنابراین هر زمان که یک طلسم به توانایی طلسم‌خوانی شما اشاره کند، از جذبه خود استفاده می‌کنید. علاوه بر این، وقتی عدد نجات یک طلسم پیمانگر را که می‌خوانید، تنظیم می‌کنید یا وقتی با آن حمله می‌کنید، از عدد اصلاحی جذبه خود استفاده می‌کنید.
...
#### کانون طلسم‌خوانی
شما می‌توانید از یک کانون جادویی (که در فصل ۵ توضیح داده شده است) به عنوان کانون طلسم‌خوانی برای طلسم‌های پیمانگر خود استفاده کنید.
...
در سطح دوم، دو توسل سحار از انتخاب خود را به دست می‌آورید. گزینه‌های توسل شما در انتهای توصیف کلاس توضیح داده شده‌اند. وقتی به سطوح خاصی از پیمانگر می‌رسید، توسل‌های بیشتری از انتخاب خود به دست می‌آورید، همان‌طور که در ستون توسل‌های دانسته در جدول پیمانگر نشان داده شده است.
...
#### پیمان کتاب
موکل شما یک کتابچه جادویی به نام کتاب سایه‌ها به شما اعطا می‌کند. وقتی این ویژگی را به دست می‌آورید، سه ورد از فهرست طلسم هر کلاسی را انتخاب کنید. در حالی که این کتاب در دست شماست، می‌توانید این ورد‌ها را به‌طور ارادی بخوانید. آنها جزو وردهای دانسته شما حساب نمی‌شوند.
...
### اسرار خفیه
در سطح یازدهم، موکل شما رازی جادویی به نام اسرار خفیه به شما اعطا می‌کند. یکی از طلسم‌های سطح ششم از فهرست طلسم‌های پیمانگر را به عنوان این راز خفیه انتخاب کنید.
...
در سطوح بالاتر، طلسم‌های بیشتری از فهرست طلسم‌های پیمانگر را که می‌توانید به این شکل بخوانید، به دست می‌آورید: یک طلسم سطح هفتم در سطح سیزدهم، یک طلسم سطح هشتم در سطح پانزدهم و یک طلسم سطح نهم در سطح هفدهم. تمام سهمیه‌های اسرار خفیه خود را وقتی یک استراحت طولانی انجام می‌دهید، بازیابی می‌کنید.
...
## موکلان فراطبیعی
موجوداتی که به عنوان موکل برای پیمانگران عمل می‌کنند، ساکنان قدرتمند پهنه‌های دیگر وجود هستند؛ نه ایزدان، اما تقریباً ایزدان‌گونه در قدرت خود. موکلان مختلف به پیمانگران خود دسترسی به قدرت‌ها و توسل‌های مختلفی می‌دهند و در مقابل انتظار خدمات قابل توجهی دارند.

برخی از موکلان پیمانگران را جمع‌آوری می‌کنند، دانش اسرارآمیز را نسبتاً آزادانه توزیع می‌کنند یا از توانایی خود برای مطیع کردن مردمان به اراده خود، مباهات می‌کنند. برخی دیگر قدرت خود را فقط با اکراه اعطا می‌کنند و ممکن است فقط با یک پیمانگر پیمان ببندند. پیمانگرانی که به یک موکل خدمت می‌کنند، ممکن است یکدیگر را به عنوان متحدان، برادران یا رقبای خود ببینند.
...
ارباب بزرگ پری به شما اجازه می‌دهد تا از فهرستی گسترش‌یافته از طلسم‌ها انتخاب کنید وقتی یک طلسم پیمانگر یاد می‌گیرید. طلسم‌های زیر به فهرست طلسم‌های پیمانگر برای شما اضافه می‌شوند.
...
#### دفاع‌های فریبنده
از سطح دهم، موکل شما به شما آموزش می‌دهد که چگونه جادوی دستکاری ذهن دشمنان خود را علیه آنها برگردانید. شما در برابر افسون شدن مصون هستید و وقتی یک موجود دیگری تلاش می‌کند شما را افسون کند، می‌توانید به عنوان یک واکنش تلاش کنید تا افسون را به آن موجود برگردانید. آن موجود باید یک تاس نجات درایت در برابر عدد نجات طلسم شما انجام دهد یا توسط شما افسون می‌شود و برای یک دقیقه یا تا زمانی که آسیب ببیند، افسون می‌شود.

#### جنون تاریک
از سطح چهاردهم، شما می‌توانید یک موجود را به یک قلمرو توهمی فرو ببرید. به عنوان یک فعالیت، یک موجود را که در ۶۰ فوتی شما قرار دارد، انتخاب کنید. آن موجود باید یک تاس نجات درایت در برابر عدد نجات طلسم شما انجام دهد. در صورت عدم موفقیت، توسط شما افسون یا ترسانده می‌شود (انتخاب خودتان) برای یک دقیقه یا تا زمانی که تمرکز شما شکسته شود (همان‌طور که اگر مشغول خواندن یک طلسم باشید). این اثر وقتی که موجود آسیب ببیند، زودتر پایان می‌یابد.
...
#### فهرست طلسم‌های گسترش‌یافته
دیو به شما اجازه می‌دهد تا از فهرستی گسترش‌یافته از طلسم‌ها انتخاب کنید وقتی یک طلسم پیمانگر یاد می‌گیرید. طلسم‌های زیر به فهرست طلسم‌های پیمانگر برای شما اضافه می‌شوند.
...
#### برکت دیو
از سطح اول، وقتی یک موجود خصمانه را به ۰ امتیاز جان کاهش می‌دهید، امتیاز جان موقتی برابر با عدد اصلاحی جذبه شما + سطح پیمانگر خود (حداقل ۱) به دست می‌آورید.
...
#### فهرست طلسم‌های گسترش‌یافته
کهن بزرگ به شما اجازه می‌دهد تا از فهرستی گسترش‌یافته از طلسم‌ها انتخاب کنید وقتی یک طلسم پیمانگر یاد می‌گیرید. طلسم‌های زیر به فهرست طلسم‌های پیمانگر برای شما اضافه می‌شوند.
...
اگر یک توسل سحار پیش‌نیازهایی داشته باشد، باید آنها را برآورده کنید تا آن را یاد بگیرید. شما می‌توانید این توسل را در همان زمانی که پیش‌نیازهای آن را برآورده می‌کنید، یاد بگیرید.
...
شما می‌توانید یک بار طلسم اجبار را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.

#### کتاب اسرار باستانی
*پیش‌نیاز: ویژگی پیمان کتاب*

شما اکنون می‌توانید مراسم جادویی را در کتاب سایه‌های خود ثبت کنید. دو طلسم سطح اول را که برچسب مراسم دارند، از فهرست طلسم هر کلاسی انتخاب کنید. این طلسم‌ها در کتاب ظاهر می‌شوند و جزو طلسم‌های دانسته شما حساب نمی‌شوند. با کتاب سایه‌های خود در دست، می‌توانید طلسم‌های انتخاب‌شده را به عنوان مراسم بخوانید. شما نمی‌توانید این طلسم‌ها را به جز به عنوان مراسم بخوانید، مگر اینکه آنها را به نحوی دیگر یاد گرفته باشید. همچنین می‌توانید یک طلسم پیمانگر را که برچسب مراسم دارد، به عنوان یک مراسم بخوانید.

در ماجراجویی‌های خود، می‌توانید طلسم‌های مراسم دیگر را به کتاب سایه‌های خود اضافه کنید. وقتی چنین طلسمی را پیدا می‌کنید، می‌توانید آن را به کتاب اضافه کنید اگر سطح طلسم برابر یا کمتر از نصف سطح پیمانگر شما (گرد شده به بالا) باشد و اگر بتوانید زمانی را برای رونویسی طلسم اختصاص دهید. برای هر سطح طلسم، فرایند رونویسی دو ساعت زمان می‌برد و ۵۰ سکه طلا برای جوهرهای کمیاب مورد نیاز برای رونویسی هزینه دارد.
...
شما می‌توانید یک بار طلسم سردرگمی را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.
...
شما می‌توانید یک بار طلسم احضار عنصرینه را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.

#### ذهن سردرگم
*پیش‌نیاز: سطح پنجم*

شما می‌توانید یک بار طلسم کندی را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.
...
شما می‌توانید یک بار طلسم تغییرشکل را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.

#### نشانه بدشگونی
*پیش‌نیاز: سطح پنجم*

شما می‌توانید یک بار طلسم نفرین را با یک سهمیه طلسم پیمانگر بخوانید. نمی‌توانید دوباره این کار را انجام دهید مگر اینکه یک استراحت طولانی انجام دهید.
