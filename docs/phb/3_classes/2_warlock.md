...
جادویی که به یک پیمانگر اعطا می‌شود، از تغییرات کوچک اما ماندگار در وجود پیمانگر (مانند توانایی دیدن در تاریکی یا خواندن هر زبانی) تا دسترسی به طلسم‌های قدرتمند را شامل می‌شود. برخلاف جادوگرهای کتاب‌خوان، پیمانگران جادوی خود را با کمی مهارت در نبرد تن‌به‌تن تکمیل می‌کنند. آن‌ها در زره سبک راحت هستند و می‌دانند که چگونه از سلاح‌های ساده استفاده کنند.

## کاوش در اسرار
پیمانگران توسط نیاز سیری‌ناپذیری به دانش و قدرت هدایت می‌شوند که آن‌ها را به سوی پیمان‌هایشان سوق می‌دهد و زندگی‌شان را شکل می‌دهد. این تشنگی پیمانگران را به سوی پیمان‌هایشان سوق می‌دهد و مسیر حرفه‌ای آن‌ها را نیز شکل می‌دهد.
